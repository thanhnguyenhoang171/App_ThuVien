...
INSERT INTO Sach (ma_sach, ten_sach, tac_gia, the_loai, mo_ta, so_luong_hien_co, gia, nam_xuat_ban)
VALUES 
	('S001', N'Harry Potter', N'J.K. Rowling', N'Fantasy', N'Cuốn sách kể về thế giới phù thủy', 100, 15.99, 2001),
	('S002', N'Nhà giả kim', N'Paulo Coelho', N'Tiểu thuyết', N'Cuốn sách về sự tìm kiếm ý nghĩa cuộc sống', 50, 12.5, 1988),
    ('S003', N'Sức mạnh của ngôn từ', N'Don Miguel Ruiz', N'Phát triển bản thân', N'Tác phẩm về sức mạnh của từ ngữ', 30, 10.99, 1997),
    ('S004', N'Nghệ thuật sống', N'Thích Nhất Hạnh', N'Tâm lý - Tâm linh', N'Sách về nghệ thuật sống hạnh phúc', 20, 9.75, 2012),
	('S005', N'Gatsby Vĩ Đại', N'F. Scott Fitzgerald', N'Kinh điển', N'Tiểu thuyết được đặt trong thập niên hồi sinh sức sống', 40, 9.99, 1925),
    ('S006', N'Tiểu thư Hobbit', N'J.R.R. Tolkien', N'Fantasy', N'Tiểu thuyết phiêu lưu giả tưởng', 60, 14.50, 1937),
    ('S007', N'Kẻ Bắt Cỏ', N'J.D. Salinger', N'Tiểu thuyết lớn lên', N'Tiểu thuyết về lo âu của tuổi teen', 70, 10.25, 1951),
	('S008', N'Đắc nhân tâm', N'Dale Carnegie', N'Tự phát triển', N'Trải nghiệm về kỹ năng giao tiếp và quản lý tâm trí', 90, 8.75, 1936),
    ('S009', N'Giáo dục', N'Emile', N'Khoa học xã hội', N'Giáo trình về giáo dục và phát triển cá nhân', 55, 10.50, 1762),
    ('S010', N'Tiếng chim hót trong bụi mận gai', N'Harper Lee', N'Tiểu thuyết', N'Truyện về sự vô tội và bất công', 65, 13.25, 1960);
...
CREATE TABLE The_thu_vien (
    ...
    ngay_dang_ky DATE,
    ngay_het_han DATE,
    CONSTRAINT chk_ngay CHECK (ngay_het_han > ngay_dang_ky)
);
...
VALUES 
    ('T001', N'Nguyễn Lê Minh Khuê', N'123 Đường ABC, Quận XYZ', '0987654321', 'nguyenkhue@example.com', '2024-05-01', '2025-05-01'),
    ('T002', N'Nguyễn Hoàng Thanh', N'456 Đường XYZ, Quận ABC', '0123456789', 'hthanh@example.com', '2024-05-15', '2025-05-15'),
